...
namespace Batheer.Application.Requests.ResponsibleFamilyMembers.Commands.CreateResponsibleFamilyMember
{
    public class CreateResponsibleFamilyMemberCommand : IRequest<int>
    {
    ...
    public class CreateResponsibleFamilyMemberCommandHandler : IRequestHandler<CreateResponsibleFamilyMemberCommand, int>
    {
        private readonly IApplicationDbContext _context;
        private readonly IMapper _mapper;
        private readonly ILogger _logger;

        public CreateResponsibleFamilyMemberCommandHandler(IApplicationDbContext context, IMapper mapper, ILogger<CreateResponsibleFamilyMemberCommand> logger)
        {
            _context = context;
            _mapper = mapper;
            _logger = logger;
        ...
        public async Task<int> Handle(CreateResponsibleFamilyMemberCommand request, CancellationToken cancellationToken)
        {
            ...
            entity = _mapper.Map<CreateResponsibleFamilyMemberCommand, FamilyRegistrationRequest>(request);

            entity.Family = new Family();
           // entity.Family.ResponsibleFamilyMember
