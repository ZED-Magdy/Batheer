    ...
    public class VisitingFamilyMemberResultDto : IMapFrom<VisitingFamilyMemberResult>
    {
        ...
        public void Mapping(Profile profile)
        {
            profile.CreateMap<VisitingFamilyMemberResult, VisitingFamilyMemberResultDto>()
                ...
                .ForMember(f => f.AssociationsAffiliatedWithTheCouncilName, to => to.MapFrom(s => s.FamilyMember.Family.FamilyRegistrationRequest.AssociationsAffiliatedWithTheCouncil.Name))
